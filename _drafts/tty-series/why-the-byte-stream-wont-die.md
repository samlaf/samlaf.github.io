...
![every TUI framework bottoms out in the same substrate](/assets/tty-series/tui-why-the-byte-stream-wont-die/tui-stacks.svg)
...
![the terminal substrate vs the GUI substrate](/assets/tty-series/tui-why-the-byte-stream-wont-die/two-substrates.svg)
