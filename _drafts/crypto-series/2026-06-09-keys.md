...
> This is Part 4 of a six-part [series on applied cryptography](/programming/crypto-series-intro.html).
>
...
> - **Part 4: Keys** — the life of a key: the entropy that seeds it, where it lives, and how it's wrapped.
...
![image](/assets/crypto-series/keys/meta-map-secrets-data.png)
...
![image](/assets/crypto-series/keys/entropy-stack.png)
...
![image](/assets/crypto-series/keys/where-keys-live-device-vs-server.png)
...
These keys are all only as trustworthy as the anchor at the top of their chain. Where those anchors come from, and how a key gets bound to a *name* at all, is the [identity series](/programming/identity-series-intro.html) — the [hosts post](/programming/identity-of-hosts.html#roots-of-trust) for the roots, the [workloads post](/programming/identity-of-workloads.html) for attestation.
