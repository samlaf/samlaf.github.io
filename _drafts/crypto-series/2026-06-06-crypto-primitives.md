...
5. [Authenticated Encryption - Wikipedia][ae-wiki]
6. [CAESAR: Competition for Authenticated Encryption][caesar]
...
[caesar]: https://competitions.cr.yp.to/caesar.html "CAESAR: Competition for Authenticated Encryption: Security, Applicability, and Robustness"
